...
* [**TinyTools**](https://tinytools-smoky.vercel.app/) [Web / *Free* & [*Open-source*](https://github.com/alfredoautomatizaloconia-cloud/tinytools)] - Single-purpose browser-based productivity utilities, no signup, no upload; domain name generator, OG image generator, favicon generator, color palette, SEO meta tag generator, AI cost calculator, AI background remover and more.
