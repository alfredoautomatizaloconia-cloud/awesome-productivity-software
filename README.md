...
* [**TinyTools**](https://tinytools-smoky.vercel.app/) [Web / *Free* & [*Open-source*](https://github.com/alfredoautomatizaloconia-cloud/tinytools)] - Single-purpose browser-based utilities for makers, no signup required: domain-name generator, OG image generator, AI background remover (runs locally), favicon generator, color palette, SEO meta tags and more.
